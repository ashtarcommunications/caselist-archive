var image_path="";
var image_up="$xwiki.getSkinFile('js/xwiki/table/img/arrow-up.gif'/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/table/js/xwiki/table/img/arrow-up.gif*/)";
var image_down="$xwiki.getSkinFile('js/xwiki/table/img/arrow-down.gif'/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/table/js/xwiki/table/img/arrow-down.gif*/)";
var image_none="$xwiki.getSkinFile('js/xwiki/table/img/arrow-none.gif'/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/table/js/xwiki/table/img/arrow-none.gif*/)";
