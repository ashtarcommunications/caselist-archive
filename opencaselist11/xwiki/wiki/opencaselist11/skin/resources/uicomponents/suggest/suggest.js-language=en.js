...
}}var h=Event.fire(this.fld,"xwiki:suggest:selected",{suggest:this,id:this.iHighlighted.down(".suggestId").innerHTML,value:this.iHighlighted.down(".suggestValue").innerHTML,info:this.iHighlighted.down(".suggestInfo").innerHTML,icon:this.iHighlighted.down("img.icon"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/wiki/opencaselist11/skin/resources/uicomponents/suggest/img.icon*/)?this.iHighlighted.down("img.icon"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/wiki/opencaselist11/skin/resources/uicomponents/suggest/img.icon*/).src:""});
...
var e=this;
if(c&&c.parentNode){if(this.options.fadeOnClear){var d=new Effect.Fade(c,{duration:"0.25"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/wiki/opencaselist11/skin/resources/uicomponents/suggest/0.25*/,afterFinish:function(){if($(e.container)){$(e.container).remove()
}}})
