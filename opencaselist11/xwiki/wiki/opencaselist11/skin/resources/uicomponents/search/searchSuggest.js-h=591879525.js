var XWiki = (function (XWiki) {
  ...
  function init(){
    var sources = [
        ...
        name : "Document name",
        varname : 'input',
        script : "/xwiki/wiki/opencaselist11/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=name:__INPUT__* OR web:__INPUT__*&nb=3&",
        ...
        varname : 'input',
        script : "/xwiki/wiki/opencaselist11/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=__INPUT__*&nb=3&",
        icon : "../../../../../../resources/icons/silk/page_white_text.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/icons/silk/page_white_text.png*/,
        highlight:  false       },
                      {
        name : "Attachment name",
        varname : 'input',
        script : "/xwiki/wiki/opencaselist11/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=name:__INPUT__* AND type:attachment&nb=3&",
        icon : "../../../../../../resources/icons/silk/attach.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/icons/silk/attach.png*/,
        highlight:  true       },
                      {
        name : "Attachment content",
        varname : 'input',
        script : "/xwiki/wiki/opencaselist11/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=__INPUT__* AND type:attachment&nb=3&",
        icon : "../../../../../../resources/icons/silk/attach.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/icons/silk/attach.png*/,
        highlight:  false       },
                                {
        name : "Users",
        varname : 'input',
        script : "/xwiki/wiki/opencaselist11/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=__INPUT__* AND object:XWiki.XWikiUsers&nb=3&",
