...
}XWiki.constants.rest={baseRestURI:XWiki.contextPath+"/rest/",restChildrenRel:"../../../../../../../../../www.xwiki.org/rel/children"/*tpa=http://www.xwiki.org/rel/children*/,restParentRel:"../../../../../../../../../www.xwiki.org/rel/parent"/*tpa=http://www.xwiki.org/rel/parent*/,restAttachmentsRel:"../../../../../../../../../www.xwiki.org/rel/attachments"/*tpa=http://www.xwiki.org/rel/attachments*/,restHomeRel:"../../../../../../../../../www.xwiki.org/rel/home"/*tpa=http://www.xwiki.org/rel/home*/};
isc.ClassFactory.defineClass("XWEResultTree",isc.ResultTree);
isc.XWEResultTree.addClassProperties({constants:{addNodeSuffix:"..new",pageHint:"Located in",attachmentsTitle:"Attachments",attachmentsHint:"Attachments of",attachmentHint:"Attached to",addPageTitle:"New page...",addPageHint:"New page in",addAttachmentTitle:"Upload file...",addAttachmentHint:"Upload file to"}});
...
isc.XWEDataSource.addProperties({dataFormat:"xml",xmlNamespaces:{xwiki:"../../../../../../../../../www.xwiki.org/index.htm"/*tpa=http://www.xwiki.org/*/},resultTreeClass:"XWEResultTree",transformResponse:function(b,a,d){if(this.callbacks.transformResponse.length>0){var c=this.callbacks.transformResponse.shift();
c.callback(b,a,d)
}return b
},dataURL:XWiki.constants.rest.baseRestURI+"wikis/",recordXPath:"/xwiki:wikis/xwiki:wiki",fields:[{name:"id",required:true,type:"text",primaryKey:true},{name:"name",type:"text"},{name:"title",type:"text"}],icon:"../../../../../../../resources/icons/silk/database.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/icons/silk/database.png*/,requestProperties:{promptStyle:"cursor",willHandleError:true},callbacks:{transformResponse:new Array()}});
...
isc.XWESpaceDataSource.addProperties({wiki:"xwiki",space:"Main",recordXPath:"/xwiki:pages/xwiki:pageSummary",fields:[{name:"id",required:true,type:"text",primaryKey:true},{name:"wiki",required:true,type:"text"},{name:"space",required:true,type:"text"},{name:"name",required:true,type:"text"},{name:"title",required:true,type:"text"},{name:"parentId",required:true,type:"text",foreignKey:"id"},{name:"xwikiRelativeUrl",type:"text"},{name:"link",propertiesOnly:true}],icon:"../../../../../../../resources/icons/silk/page_white_text.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/icons/silk/page_white_text.png*/});
...
isc.XWEPageDataSource.addProperties({wiki:"xwiki",space:"Main",page:"WebHome",recordXPath:"/xwiki:page",fields:[{name:"id",required:true,type:"text",primaryKey:true},{name:"wiki",required:true,type:"text"},{name:"space",required:true,type:"text"},{name:"name",required:true,type:"text"},{name:"parentId",required:true,type:"text"},{name:"link",propertiesOnly:true}],icon:"../../../../../../../resources/icons/silk/page_white_text.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/icons/silk/page_white_text.png*/});
...
},showHeader:false,folderIcon:"../../../../../../../resources/icons/silk/database.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/icons/silk/database.png*/,position:"relative",dropIconSuffix:"",openIconSuffix:"",closedIconSuffix:"",animateFolders:false,wiki:XWiki.currentWiki,space:null,displaySuggest:true,defaultValue:"Main.WebHome",inputValueCache:""});
