...
}}else{a.JumpToPage=Class.create(a.ModalPopup,{urlTemplate:"/xwiki/wiki/opencaselist/__action__/__space__/__document__",initialize:function($super){var e=new Element("div");
