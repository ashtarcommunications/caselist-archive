...
}}else{a.Suggest=Class.create({options:{minchars:1,method:"get",varname:"input",className:"ajaxsuggest",timeout:2500,delay:500,offsety:0,shownoresults:true,noresults:"No results!",maxheight:250,cache:false,seps:"",icon:null,resultsParameter:"results",resultId:"id",resultValue:"value",resultInfo:"info",resultIcon:"icon",resultHint:"hint",parentContainer:"body",highlight:true,fadeOnClear:true,enableHideButton:true,insertBeforeSuggestions:null,displayValue:false,displayValueText:"Value: ",align:"left",unifiedLoader:false,loaderNode:null},sInput:"",nInputChars:0,aSuggestions:[],iHighlighted:null,isActive:false,initialize:function(c,d){if(!c){return false
...
}}if(this.options.enableHideButton&&!this.container.down(".hide-button")){var h=new Element("span",{"class":"hide-button"}).update("hide suggestions");
...
}}var h=Event.fire(this.fld,"xwiki:suggest:selected",{suggest:this,id:this.iHighlighted.down(".suggestId").innerHTML,value:this.iHighlighted.down(".suggestValue").innerHTML,info:this.iHighlighted.down(".suggestInfo").innerHTML,icon:this.iHighlighted.down("img.icon"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/wiki/workspacetemplate.template.local/skin/resources/uicomponents/suggest/img.icon*/)?this.iHighlighted.down("img.icon"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/wiki/workspacetemplate.template.local/skin/resources/uicomponents/suggest/img.icon*/).src:""});
...
var e=this;
if(c&&c.parentNode){if(this.options.fadeOnClear){var d=new Effect.Fade(c,{duration:"0.25"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/wiki/workspacetemplate.template.local/skin/resources/uicomponents/suggest/0.25*/,afterFinish:function(){if($(e.container)){$(e.container).remove()
}}})
