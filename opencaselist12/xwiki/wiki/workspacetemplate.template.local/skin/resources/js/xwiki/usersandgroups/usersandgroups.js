...
MSCheckbox = Class.create({
  ...
  initialize: function(domNode, right, saveUrl, defaultState, table, idx)
  {
    ...
    this.images = [
      "../../../../../../../resources/js/xwiki/usersandgroups/img/none.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/usersandgroups/img/none.png*/,
      "../../../../../../../resources/js/xwiki/usersandgroups/img/allow.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/usersandgroups/img/allow.png*/,
      "../../../../../../../resources/js/xwiki/usersandgroups/img/deny1.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/usersandgroups/img/deny1.png*/
    ];
    this.labels = ['','',''];
      ...
      self.req = new Ajax.Request(url, {
        ...
        onSuccess: function(transport) {
          if (transport.responseText.strip() == "SUCCESS") {
            ...
            // that action
            alert("An exception occurred while trying to save the current modifications. Please check if you have the proper rights to perform these modifications.");
            var rURL = unescape(window.location.pathname);
            window.location.href = rURL;
          }
        },
        onFailure: function() {
          alert("An error occurred while communicating with the server. Please check that the server is accessible, and you have the proper rights to perform the requested action.");
        },
        onComplete: function() {
          delete self.req;
        }
...
function displayUsers(row, i, table, form_token)
{
  ...
  if (wikiname == "local") {
    ...
    edit.src = '../../../../../../../resources/js/xwiki/usersandgroups/img/edit.png'/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/usersandgroups/img/edit.png*/;
    edit.title = "Edit";
    ...
    if (row.grayed == "true") {
      del.src = '../../../../../../../resources/js/xwiki/usersandgroups/img/clearg.png'/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/usersandgroups/img/clearg.png*/;
      del.className = 'icon-manageg';
    } else {
      del.src = '../../../../../../../resources/js/xwiki/usersandgroups/img/clear.png'/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/usersandgroups/img/clear.png*/;
...
{
  return function() {
    var saveURL = "/xwiki/wiki/workspacetemplate.template.local/save/XWiki/XWikiPreferences";
    ...
    var pivot = self;
    var newAlt = "yes";
    var newSrc = "../../../../../../../resources/js/xwiki/usersandgroups/img/allow-black.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/usersandgroups/img/allow%2Dblack.png*/;
    var setValue = "1";
    if (self.getAttribute('alt') == "yes") {
      newAlt = "no";
      newSrc = "../../../../../../../resources/js/xwiki/usersandgroups/img/none.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/usersandgroups/img/none.png*/;
      setValue = "0";
    }
    var paramMap = {};
    paramMap["parameters"] = {};
...
{
  return function() {
    var url = '/xwiki/wiki/workspacetemplate.template.local/save/XWiki/XWikiPreferences';
    var pivot = self;
    if (self.getAttribute('alt') == "yes") {
      if (self.id.indexOf('view') > 0) {
        new Ajax.Request(url, {
          ...
          onSuccess: function() {
            pivot.alt = "no";
            pivot.src = "../../../../../../../resources/js/xwiki/usersandgroups/img/none.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/usersandgroups/img/none.png*/;
        }});
      } else {
        new Ajax.Request(url, {
          method: 'post',
      ...
      if (self.id.indexOf('view') > 0) {
        new Ajax.Request(url, {
          ...
          onSuccess: function() {
            pivot.alt = "yes";
            pivot.src = "../../../../../../../resources/js/xwiki/usersandgroups/img/allow-black.png"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/resources/js/xwiki/usersandgroups/img/allow%2Dblack.png*/;
        }});
      } else {
        new Ajax.Request(url, {
          method: 'post',
