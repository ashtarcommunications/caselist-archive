...
XWiki.Document.URLTemplate="/xwiki/wiki/hs/__action__/__space__/__page__";
...
}if(a){if(h||d){["blur","change","xwiki:suggest:selected"].each(function(j){a.observe(j,function(){var l={xpage:"xpart",vm:(h?"hierarchy.vm"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/wiki/hs/skin/resources/js/xwiki/hierarchy.vm*/:"space.vm"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/wiki/hs/skin/resources/js/xwiki/space.vm*/),parent:a.value};
