...
this.generatorTemplate="commentsinline.vm"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/wiki/hs/skin/resources/uicomponents/viewers/commentsinline.vm*/
...
this.generatorTemplate="comments.vm"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/wiki/hs/skin/resources/uicomponents/viewers/comments.vm*/
...
},addEditListener:function(){$$(this.xcommentSelector).each(function(d){d=d.down("a.edit"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/wiki/hs/skin/resources/uicomponents/viewers/a.edit*/);
if(!d){return
}d.observe("click",function(e){d.blur();
e.stop();
if(d.disabled){return
...
f.hide();
d._x_editForm.show()
}else{new Ajax.Request(d.readAttribute("href").replace("viewer=comments","xpage=xpart&vm=commentsinline.vm"/*tpa=http://opencaselist.paperlessdebate.com/xwiki/wiki/hs/skin/resources/uicomponents/viewers/xpage=xpart&vm=commentsinline.vm*/),{onCreate:function(){d.disabled=true;
...
}var d="/xwiki/wiki/hs/preview/__space__/__page__".replace("__space__",encodeURIComponent(c.currentSpace)).replace("__page__",encodeURIComponent(c.currentPage));
